    ...
    <div className="min-h-screen bg-[#f7f3ef] text-stone-950" dir="rtl">
      ...
      <footer className="border-t border-stone-200 bg-white">
        ...
        <div className="flex items-center justify-center gap-6 py-5 flex-wrap px-4">
          ...
          {/* Snapchat */}
          <a href="https://snapchat.com/t/0uWzwrTR" target="_blank" rel="noopener noreferrer" aria-label="Snapchat" className="text-stone-500 hover:text-[#FFFC00] transition-colors">
            <svg viewBox="0 0 24 24" className="w-6 h-6 fill-current"><path d="M12.166.011C9.979.011 7.002.632 5.22 3.367c-.895 1.373-1.08 3.1-.983 4.673-.4.205-.856.313-1.339.269-.298-.03-.62-.12-.893-.264-.1-.053-.223-.079-.338-.055-.2.04-.33.23-.29.427.05.24.26.46.55.62.06.03.12.06.18.09.5.23 1.26.47 1.44 1.06.01.05.02.1.02.15 0 .5-.38 1.13-.75 1.7-.35.54-.71 1.09-.82 1.66-.25 1.2.5 2.1 1.5 2.44.3.1.63.15.96.13.44-.03.86-.16 1.2-.35.4 1.16 1.12 2.18 2.05 2.97.7.6 1.5 1.07 2.38 1.34.08.03.16.05.24.08-.06.19-.17.44-.34.71-.21.33-.51.65-.87.89-.38.25-.75.38-1.1.38-.36 0-.67-.09-.93-.26-.26-.17-.48-.39-.68-.6-.16-.17-.37-.27-.58-.27-.23 0-.44.11-.55.3-.13.21-.1.47.08.66.5.54 1.17.97 1.9 1.22.73.25 1.52.32 2.3.21.6-.08 1.18-.27 1.72-.54.01.08.02.16.03.24.09.6.51 1.02 1.01 1.02.19 0 .38-.06.55-.16.17-.1.32-.25.42-.44l.06-.12c.09-.17.16-.38.19-.62.07-.56-.08-1.17-.4-1.68.08-.03.16-.05.24-.08.88-.27 1.68-.74 2.38-1.34.93-.79 1.65-1.81 2.05-2.97.34.19.76.32 1.2.35.33.02.66-.03.96-.13 1-.34 1.75-1.24 1.5-2.44-.11-.57-.47-1.12-.82-1.66-.37-.57-.75-1.2-.75-1.7 0-.05.01-.1.02-.15.18-.59.94-.83 1.44-1.06.06-.03.12-.06.18-.09.29-.16.5-.38.55-.62.04-.197-.09-.387-.29-.427-.115-.024-.238.002-.338.055-.273.144-.595.234-.893.264-.483.044-.939-.064-1.339-.269.097-1.573-.088-3.3-.983-4.673C14.998.632 12.353.011 12.166.011z"/></svg>
          </a>
        </div>
